...
@Component
public class ProdutoArvoreMapperImpl implements ProdutoArvoreMapper {
    ...
    public ProdutoArvoreDTO produtoArvoreToProdutoArvoreDTO(ProdutoArvore produtoArvore) {
        ...
        Set<ProdSegdPlanSegmDTO> set = map( produtoArvore.getProd() );
        if ( set != null ) {
            produtoArvoreDTO.setProdSegdPlanSegms( set );
        }
        ...
        Set<PerguntaObgDTO> set_ = perguntaObgSetToPerguntaObgDTOSet( produtoArvore.getPerguntaObgs() );
        if ( set_ != null ) {
            produtoArvoreDTO.setPerguntaObgs( set_ );
        }
